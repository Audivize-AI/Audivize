...
extension ASD {
    struct ScoreSegment: Sendable, Sequence, MutableCollection {
        ...
        public mutating func extend(with logits: any RandomAccessCollection<Float>, by count: Int) {
            ...
            guard overlapStart < scores.count else { return }
        ...
        public func comesBefore(_ other: ScoreSegment) -> Bool {
        ...
        public func comesAfter(_ other: ScoreSegment) -> Bool {
            return self.startIndex >= other.startIndex && self.endIndex >= other.endIndex
        }
        ...
        public func isEnvelopedBy(_ other: ScoreSegment) -> Bool {
            return self.startIndex >= other.startIndex && self.endIndex <= other.endIndex
        }
        
        /// Check if this score segment intersects another one
        public func intersects(_ other: ScoreSegment) -> Bool {
            return self.startIndex < other.endIndex && other.startIndex < self.endIndex
        }
        
        // MARK: - Combining score segments
        
        /// Attempt to merge this segment with another one
        /// - Parameter other: The other score segment
        /// - Returns: `true` if successful, `false` if not
        public mutating func tryMerge(_ other: ScoreSegment) -> Bool {
        ...
        /// - Parameter other: The other score segment
        /// - Returns: `true` if successful, `false` if not
        public mutating func tryMaskWith(_ other: ScoreSegment) -> Bool {
            let intersectionStart = Swift.max(self.startIndex, other.startIndex)
            let intersectionEnd = Swift.min(self.endIndex, other.endIndex)
        ...
        /// Merge this score segment with another one
        /// - Parameter other: The other score segment
        /// - Throws: `ScoreSegmentError.mergeFailedNoAdjacentScores` if unsuccessful (no intersection and non-adjacent)
        public mutating func mergeWith(_ other: ScoreSegment) throws {
            guard self.tryMerge(other) else {
        ...
        public mutating func maskWith(_ other: ScoreSegment) throws {
            guard self.tryMaskWith(other) else {
